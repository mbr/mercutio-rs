//! IO-less MCP protocol state machine.
//!
//! Implements the server side of the [Model Context Protocol][mcp] (MCP), a [JSON-RPC 2.0][jsonrpc]
//! based protocol for LLM tool integration. This module handles protocol logic without performing
...
mod tests {
    ...
    use super::{McpServer, NoTools, Output};
